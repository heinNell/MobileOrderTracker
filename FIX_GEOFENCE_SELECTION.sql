...
SELECT
    ...
    COUNT(*) FILTER
(WHERE is_active = true) as active_geofences,
    COUNT
(DISTINCT tenant_id) as unique_tenants
...
DROP POLICY
IF EXISTS "Users can view geofences from their tenant" 
...
CREATE INDEX
IF NOT EXISTS idx_enhanced_geofences_tenant_id 
ON enhanced_geofences
(tenant_id);

-- Index for active status filtering
CREATE INDEX
IF NOT EXISTS idx_enhanced_geofences_is_active 
ON enhanced_geofences
(is_active);

-- Composite index for common query pattern
CREATE INDEX
IF NOT EXISTS idx_enhanced_geofences_tenant_active 
ON enhanced_geofences
(tenant_id, is_active) 
...
CREATE INDEX
IF NOT EXISTS idx_enhanced_geofences_type 
ON enhanced_geofences
(geofence_type);
