...
export default function QRScanner({ onQRScanned }) {
  ...
  const navigateToOrder = (orderId, orderNumber) => {
    try {
      Alert.alert("Order Found!", `Opening order: ${orderNumber || orderId}`, [
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.overlay}>
        ...
        {scanned && (
          <Text style={styles.tryAgainText} onPress={() => setScanned(false)}>
            Tap to scan again
          </Text>
        )}
      </View>
