-- CORRECTED: Fix dashboard location tracking after mobile app schema changes
-- This fixes the PostgreSQL syntax error with reserved keyword "timestamp"

-- First, create a simplified function that works
...
-- Also create index on timestamp column if it exists (with quotes)
DO $$
BEGIN
...
SELECT 'Dashboard location tracking schema updated successfully - syntax corrected' AS status;
