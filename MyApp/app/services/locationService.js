 ...
 */
export function parsePostGISPoint(wkt) {
 ...
 */
export function toPostGISPoint(location) {
  if (
    !location ||
 ...
 */
export function isWithinGeofence(location, center, radiusKm) {
 ...
 */
export function isWithinSouthAfrica(location) {
